...
module ibex_register_file_ff (
	...
	genvar _gv_i_33;
	generate
		for (_gv_i_33 = 1; _gv_i_33 < NUM_WORDS; _gv_i_33 = _gv_i_33 + 1) begin : g_rf_flops
...
module ibex_register_file_latch (
	...
	genvar _gv_i_34;
	generate
		for (_gv_i_34 = 1; _gv_i_34 < NUM_WORDS; _gv_i_34 = _gv_i_34 + 1) begin : g_rf_latches
...
module ibex_top (
	...
	input wire rst_ni;
	input wire test_en_i;
	input wire [11:0] ram_cfg_icache_tag_i;
	localparam [31:0] ibex_pkg_IC_NUM_WAYS = 2;
	output wire [1:0] ram_cfg_rsp_icache_tag_o;
	input wire [11:0] ram_cfg_icache_data_i;
	output wire [1:0] ram_cfg_rsp_icache_data_o;
	input wire [31:0] hart_id_i;
	input wire [31:0] boot_addr_i;
	output wire instr_req_o;
	input wire instr_gnt_i;
	...
	generate
		if (ICache) begin : gen_rams
			...
			for (_gv_way_5 = 0; _gv_way_5 < ibex_pkg_IC_NUM_WAYS; _gv_way_5 = _gv_way_5 + 1) begin : gen_rams_inner
				...
				if (ICacheScramble) begin : gen_scramble_rams
					prim_ram_1p_scr #(
						...
						.cfg_rsp_o(ram_cfg_rsp_icache_tag_o[way+:1]),
						.wr_collision_o(),
						.write_pending_o(),
					...
					prim_ram_1p_scr #(
						...
						.cfg_rsp_o(ram_cfg_rsp_icache_data_o[way+:1]),
						.wr_collision_o(),
						.write_pending_o(),
			...
			assign ram_cfg_rsp_icache_tag_o = 1'sb0;
			assign ram_cfg_rsp_icache_data_o = 1'sb0;
	...
	generate
		...
		if (Lockstep) begin : gen_lockstep
			localparam signed [31:0] NumBufferBits = ((((((((((((((((99 + MemDataWidth) + 73) + MemDataWidth) + 1) + RegFileDataWidth) + RegFileDataWidth) + ibex_pkg_IC_NUM_WAYS) + 1) + ibex_pkg_IC_INDEX_W) + TagSizeECC) + ibex_pkg_IC_NUM_WAYS) + 1) + ibex_pkg_IC_INDEX_W) + LineSizeECC) + 184) + ibex_pkg_IbexMuBiWidth) + ibex_pkg_IbexMuBiWidth;
