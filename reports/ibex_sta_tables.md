...
| :--- | :--- | :--- | :--- |
| **Setup WNS** | `grep 'wns' <file>` | `wns max -8.65` | `wns max -37.66` |
| **Setup TNS** | `grep 'tns' <file>` | `tns max -3846.05` | `tns max -31690.22` |
| **Path Count** | `grep -c 'Startpoint:' <file>` | `60` | `60` |
| **Violated Paths** | `grep -c 'VIOLATED' <file>` | `4486` | `7458` |
| **Worst Endpoint** | `grep 'Endpoint:' <file> \| head -1` | `Endpoint: cs_registers_i/_2265_ (recovery check against rising-edge clock clk_i)` | `Endpoint: cs_registers_i/_2265_ (recovery check against rising-edge clock clk_i)` |
| **SS WNS worse than TT?** | *Manual comparison* | **Yes** (`-37.66 ns` < `-8.65 ns`) | **Yes** (`-37.66 ns` < `-8.65 ns`) |
...
-----------------------------------------------------------------------
  ...
  --> [Input Port line]: Shows external capacitance (2.58 pF), transition slew (20.72 ns), external propagation delay (14.56 ns), and cumulative launch time (14.56 ns).
          ...
          20.72    0.00   14.56 ^ cs_registers_i/_2265_/RESET_B (sky130_fd_sc_hd__dfrtp_1)
  ...
  --> [Clock Reconvergence Pessimism (CRPR)]: Reconvergence credit adjustment.
                          ...
                          19.75 ^ cs_registers_i/_2265_/CLK (sky130_fd_sc_hd__dfrtp_1)
...
| **WNS value appears after the keyword 'wns'** | `yes` (e.g. `wns max -8.65`) |
...
| :--- | :---: | :---: | :---: |
| **setup_wns (from parser)** | `-8.650` | `-37.660` | **yes** |
| **setup_wns (from grep)** | `-8.65` | `-37.66` | **yes** |
| **setup_violations (from parser)** | `4486` | `7458` | **yes** |
| **VIOLATED count (from grep)** | `4486` | `7458` | **yes** |
